...
namespace Blackjack
{
    ...
    public partial class MainWindow : Window, INotifyPropertyChanged
    {
        ...
        {
            get { return "Wins: " + TotalWins.ToString("N0") + nl + "Losses: " + TotalLosses.ToString("N0") + nl + "Draws: " + TotalDraws.ToString("N0") + nl + "Money Won: " + TotalBetWinnings.ToString("N0") + nl + "Money Lost: " + TotalBetLosses.ToString("N0"); }
        }

        public int Money
        {
            get { return _money; }
            set { _money = value; OnPropertyChanged("Statistics"); }
        }
        ...
        private void DisplayStatistics()
        {
            ...
            lblMoney.Text = "Money: " + Money.ToString("N0");
        }
        ...
        private void btnNewHand_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (bet > 0 && bet <= Money)
                ...
                MessageBox.Show("You can't bet more money than you have!", "Blackjack", MessageBoxButton.OK);
            else
                MessageBox.Show("Please enter a valid bet.", "Blackjack", MessageBoxButton.OK);
        }
